...
export const Lab6 = {
    ...
    link: [],
    TTT: [
        ['Aggregation of Us', `Inspired from the trace of U Turns at the street, this semi-project aggregates different trace of Us to create a shape, which differs on every render, and which only a computer can efficiently generate.`],
        ['Further Research', 'I believe that these shapes can be used in delivering powerful semantics in relationship with the social context. For instance, the first picture which had placed 70 different collectives, can be used to efficiently visualise the 70 different data elements.'],
    ],
    Images: [
        Lab6Img,
        Lab61,
