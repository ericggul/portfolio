...
export const Lobby1 = {
    ...
    Paragraphs: [
        {
            'Hidden Order': [
                [`Art Council Korea's <Art Talk>`, `This sculpture was conducted as the Art Council Korea(ARKO)'s Emerging Artists Program, Art Talk. The theme of this program is to expand the boundary of artistic expression in a virtual environment. ARKO is a`],
        ...
        {
            'Philosophy': [
              [`Liberating Elevators`, `This project liberates elevators from its pre-determined purpose as a transporation, resulting a nonpurposive state of aesthetics, as Kant had declared.`],
